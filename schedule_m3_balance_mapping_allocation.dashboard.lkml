- dashboard: schedule_m3_balances_and_account_allocation_variance
  ...
  description: 'Tax Accounting System | Schedule M-3 Balances and Account Allocation Variance'
  ...
  - title: "Schedule M-3 Balances and Account Allocation Variance"
    ...
    fields: [
      ...
      schedule_m3_balance_mapping_allocation.allocation_detail_voting_stock_percentage_owned,
      schedule_m3_balance_mapping_allocation.allocation_detail_class_of_voting_stock,
      schedule_m3_balance_mapping_allocation.allocation_detail_entity_name,
      schedule_m3_balance_mapping_allocation.allocation_detail_employer_identification_number,
      schedule_m3_balance_mapping_allocation.allocation_detail_eoy_loss_sharing_percentage,
      schedule_m3_balance_mapping_allocation.allocation_detail_eoy_profit_sharing_percentage,
      schedule_m3_balance_mapping_allocation.allocation_detail_entity_type,
      schedule_m3_balance_mapping_allocation.allocation_detail_reason_for_missing_ein,
      schedule_m3_balance_mapping_allocation.allocation_detail_reportable_transaction_description,
      schedule_m3_balance_mapping_allocation.allocation_detail_reportable_transaction_type,
      schedule_m3_balance_mapping_allocation.allocation_detail_tax_shelter_name,
      schedule_m3_balance_mapping_allocation.allocation_detail_tax_shelter_registration_number,
      schedule_m3_balance_mapping_allocation.federal_chart_of_accounts_name,
      ...
      schedule_m3_balance_mapping_allocation.employer_identification_number,
      ...
      schedule_m3_balance_mapping_allocation.schedule_m3_code,
      schedule_m3_balance_mapping_allocation.schedule_m3_column,
      schedule_m3_balance_mapping_allocation.schedule_m3_column_heading,
      schedule_m3_balance_mapping_allocation.schedule_m3_form_line_description,
      schedule_m3_balance_mapping_allocation.schedule_m3_form_line_number,
      ...
      schedule_m3_balance_mapping_allocation.tcc,
      schedule_m3_balance_mapping_allocation.tcc_description,
      schedule_m3_balance_mapping_allocation.trc,
      schedule_m3_balance_mapping_allocation.trc_category_description,
      schedule_m3_balance_mapping_allocation.trc_description,
      schedule_m3_balance_mapping_allocation.variance_amount_usd,
      schedule_m3_balance_mapping_allocation.workarea
    ]
    sorts: [
      schedule_m3_balance_mapping_allocation.account_description asc,
      schedule_m3_balance_mapping_allocation.account_number asc,
      schedule_m3_balance_mapping_allocation.adjustment_description asc,
      schedule_m3_balance_mapping_allocation.adjustment_number asc,
      schedule_m3_balance_mapping_allocation.allocation_detail_voting_stock_percentage_owned asc,
      schedule_m3_balance_mapping_allocation.allocation_detail_class_of_voting_stock asc,
      schedule_m3_balance_mapping_allocation.allocation_detail_entity_name asc,
      schedule_m3_balance_mapping_allocation.allocation_detail_employer_identification_number asc,
      schedule_m3_balance_mapping_allocation.allocation_detail_eoy_loss_sharing_percentage asc,
      schedule_m3_balance_mapping_allocation.allocation_detail_eoy_profit_sharing_percentage asc,
      schedule_m3_balance_mapping_allocation.allocation_detail_entity_type asc,
      schedule_m3_balance_mapping_allocation.allocation_detail_reason_for_missing_ein asc,
      schedule_m3_balance_mapping_allocation.allocation_detail_reportable_transaction_description asc,
      schedule_m3_balance_mapping_allocation.allocation_detail_reportable_transaction_type asc,
      schedule_m3_balance_mapping_allocation.allocation_detail_tax_shelter_name asc,
      schedule_m3_balance_mapping_allocation.allocation_detail_tax_shelter_registration_number asc,
      schedule_m3_balance_mapping_allocation.federal_chart_of_accounts_name asc,
      schedule_m3_balance_mapping_allocation.binder_name asc,
      schedule_m3_balance_mapping_allocation.binder_return_type asc,
      schedule_m3_balance_mapping_allocation.binder_year asc,
      schedule_m3_balance_mapping_allocation.entity_number asc,
      schedule_m3_balance_mapping_allocation.employer_identification_number asc,
      schedule_m3_balance_mapping_allocation.entity_name asc,
      schedule_m3_balance_mapping_allocation.entity_type asc,
      schedule_m3_balance_mapping_allocation.entity_international_filing_type asc,
      schedule_m3_balance_mapping_allocation.schedule_m3_code asc,
      schedule_m3_balance_mapping_allocation.schedule_m3_column asc,
      schedule_m3_balance_mapping_allocation.schedule_m3_column_heading asc,
      schedule_m3_balance_mapping_allocation.schedule_m3_form_line_description asc,
      schedule_m3_balance_mapping_allocation.schedule_m3_form_line_number asc,
      schedule_m3_balance_mapping_allocation.schedule_m3_form_part_description asc,
      schedule_m3_balance_mapping_allocation.tas_allocation_amount_usd asc,
      schedule_m3_balance_mapping_allocation.tas_balance_amount_usd asc,
      schedule_m3_balance_mapping_allocation.tcc asc,
      schedule_m3_balance_mapping_allocation.tcc_description asc,
      schedule_m3_balance_mapping_allocation.trc asc,
      schedule_m3_balance_mapping_allocation.trc_category_description asc,
      schedule_m3_balance_mapping_allocation.trc_description asc,
      schedule_m3_balance_mapping_allocation.variance_amount_usd asc,
      schedule_m3_balance_mapping_allocation.workarea asc
    ]
    limit: 500
    title_hidden: false
    default_version: 1
