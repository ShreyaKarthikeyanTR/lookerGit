- dashboard: schedule_m3_balance_mapping_allocation
  ...
  description: "Report Name: Schedule M-3 Balances and Account Allocation Variance"
  ...
  - title: "Schedule M-3 Balances and Account Allocation Variance"
    ...
    note_state: expanded
    note_display: hover
    note_text: "Tax Accounting System | Schedule M-3 Balances and Account Allocation"
    model: DataQuery
    explore: schedule_m3_balance_mapping_allocation
    fields: [schedule_m3_balance_mapping_allocation.workarea,
      ...
      schedule_m3_balance_mapping_allocation.allocation_detail_company_name,
      ...
      schedule_m3_balance_mapping_allocation.allocation_detail_class_of_stock_ownership_percentage,
      ...
      schedule_m3_balance_mapping_allocation.allocation_detail_end_of_year_loss_sharing_percentage,
      schedule_m3_balance_mapping_allocation.allocation_detail_end_of_year_profit_sharing_percentage,
      ...
      schedule_m3_balance_mapping_allocation.system_binder_id,
      schedule_m3_balance_mapping_allocation.system_entity_id,
    ...
    sorts: [schedule_m3_balance_mapping_allocation.workarea asc,
      ...
      schedule_m3_balance_mapping_allocation.allocation_detail_company_name asc,
    ...
    column_order: [schedule_m3_balance_mapping_allocation.workarea,
      schedule_m3_balance_mapping_allocation.entity_number,
      schedule_m3_balance_mapping_allocation.entity_name,
      schedule_m3_balance_mapping_allocation.binder_year,
      schedule_m3_balance_mapping_allocation.binder_name,
    ...
    series_labels:
      ...
      schedule_m3_balance_mapping_allocation.allocation_detail_company_name: Allocation Detail: Entity Name
      ...
      schedule_m3_balance_mapping_allocation.allocation_detail_class_of_stock_ownership_percentage: Allocation Detail: Voting Stock Percentage Owned
      schedule_m3_balance_mapping_allocation.allocation_detail_class_of_voting_stock: Allocation Detail: Class of Voting Stock
      schedule_m3_balance_mapping_allocation.allocation_detail_employer_identification_number: Allocation Detail: Enity EIN
      schedule_m3_balance_mapping_allocation.allocation_detail_end_of_year_loss_sharing_percentage: Allocation Detail: EOY Loss-Sharing Percentage
      schedule_m3_balance_mapping_allocation.allocation_detail_end_of_year_profit_sharing_percentage: Allocation Detail: EOY Profit-Sharing Percentage
      ...
      schedule_m3_balance_mapping_allocation.system_binder_id: System Binder ID
      schedule_m3_balance_mapping_allocation.system_entity_id: System Entity ID
      schedule_m3_balance_mapping_allocation.tas_allocation_amount_usd: Allocation Detail: Allocation Amount
      schedule_m3_balance_mapping_allocation.tas_balance_amount_usd: Balance
      ...
      schedule_m3_balance_mapping_allocation.variance_amount_usd: Allocation Detail: Variance Amount
