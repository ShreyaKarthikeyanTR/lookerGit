view: schedule_m3_balance_mapping_allocation {
  sql_table_name: `b056e491eba9.schedule_m3_balance_mapping_allocation.binder_test` ;;
  ...
  dimension: allocation_detail_class_of_stock_ownership_percentage {
    type: string
  ...
  dimension: allocation_detail_company_name {
    type: string
  ...
  dimension: allocation_detail_end_of_year_loss_sharing_percentage {
    type: string
    sql: ${TABLE}.eoy_loss_pct ;;
  }

  dimension: allocation_detail_end_of_year_profit_sharing_percentage {
    type: string
