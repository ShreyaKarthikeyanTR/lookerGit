- dashboard: schedule_m3_balances_and_account_allocation_variance
  ...
  description: 'Report showing Schedule M-3 Balances and Account Allocation Variance data.'
  ...
  - title: "Schedule M-3 Balances and Account Allocation Variance"
    ...
    fields: [schedule_m3_balance_mapping_allocation.account_description,
      ...
      schedule_m3_balance_mapping_allocation.entity_type_main,
      ...
      schedule_m3_balance_mapping_allocation.trc_description_main,
    ...
    sorts: [schedule_m3_balance_mapping_allocation.binder_year desc,
    ...
    column_order: [schedule_m3_balance_mapping_allocation.account_description,
      schedule_m3_balance_mapping_allocation.account_number,
      schedule_m3_balance_mapping_allocation.adjustment_description,
      schedule_m3_balance_mapping_allocation.adjustment_number,
      schedule_m3_balance_mapping_allocation.allocation_detail_voting_stock_percentage_owned,
    ...
    series_labels:
      ...
      schedule_m3_balance_mapping_allocation.entity_type_main: Entity Type
      ...
      schedule_m3_balance_mapping_allocation.trc_description_main: TRC Description
