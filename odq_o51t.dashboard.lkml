- dashboard: schedule_m3_balances_and_account_allocation_variance
  ...
  description: "Detailed dashboard report from the schedule_m3_balance_mapping_allocation table showing balances, account mappings, and allocation variances."
  ...
  - title: "Schedule M-3 Balances and Account Allocation Variance"
    ...
    sorts: [schedule_m3_balance_mapping_allocation.entity_workarea_name asc,
