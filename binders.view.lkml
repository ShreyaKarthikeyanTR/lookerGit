view: binders {
  ...
  dimension: retained_earnings_closing_account_description {
    type: string
    sql: ${TABLE}.retained_earnings_closing_account_description ;;
  }
  ...
  dimension: jurisdiction_display_order {
    type: string
    sql: CAST(${TABLE}.jurisdiction_display_order AS STRING) ;;
  }
